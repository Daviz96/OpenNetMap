...
**Branch attivo:** `main` (pulito — Sprint 1-8 tutti mergiati, PR #2..#12)  
...
| Sprint 8 — Topology Engine fisico L3 | `sprint/8-topology-physical` (PR #12 merged) | 151 test, coverage ~69.5% |
